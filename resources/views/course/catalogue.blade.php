...
@section('content')
    <x-app.page-header>
        <x-slot:pretitle>Browse</x-slot:pretitle>
        <x-slot:title>Courses</x-slot:title>

        <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
                @if(auth()->user()->role == \App\Enums\UserRole::MENTOR)
                    <a href="{{ route('course.new') }}" class="btn btn-primary d-none d-sm-inline-block">
