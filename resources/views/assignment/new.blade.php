...
@section('content')
    ...
    <div class="page-body">
        <div class="container-xl">
            <form action="{{ route('assignment.create', ['course' => $course]) }}" method="post" class="row row-cards" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <select type="text" class="form-select" id="material_id" name="material_id" value="">
                            ...
                            <div class="mb-3">
                                ...
                                <span class="input-icon-addon">
                                    ...
                                    <input class="form-control @error('deadline_at') is-invalid @enderror" placeholder="Select a date" id="deadline_at" name="deadline_at" value="{{ old('deadline_at') }}">
                                </div>
                                @error('deadline_at')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
